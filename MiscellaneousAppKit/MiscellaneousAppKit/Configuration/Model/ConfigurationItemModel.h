...
+ (ConfigurationItemModel *)itemModelWithType:(ConfigurationItemModelType)type label:(NSString *)label valueResolver:(ValueType<NSCopying> (^)(ConfigurationItemModel * itemModel))valueResolver;
