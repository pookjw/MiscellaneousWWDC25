...
- (void)viewDidLoad {
    ...
    MPU_CAFrameRateRange preferredFrameRateRange = reinterpret_cast<MPU_CAFrameRateRange (*)(id, SEL)>(objc_msgSend)(updateLink, sel_registerName("preferredFrameRateRange"));
    preferredFrameRateRange.maximum = 60;
    preferredFrameRateRange.minimum = 1;
    preferredFrameRateRange.preferred = 60;
    reinterpret_cast<void (*)(id, SEL, MPU_CAFrameRateRange)>(objc_msgSend)(updateLink, sel_registerName("setPreferredFrameRateRange:"), preferredFrameRateRange);
