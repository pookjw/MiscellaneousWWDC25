...
- (CPListTemplate *)_makeDemoListTemplate {
    ...
    for (NSUInteger sectionIndex : std::views::iota(0, 10)) {
        ...
        for (NSUInteger itemIndex : std::views::iota(0, 3)) {
            ...
            if (@available(iOS 26.0, *)) {
                if (itemIndex % 6 == 1) {
                    NSMutableArray<__kindof CPListImageRowItemElement *> *elements = [NSMutableArray new];
                    
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemCardElement *element = [[CPListImageRowItemCardElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]
                                                                                                 showsImageFullHeight:YES
                                                                                                                title:@"Card"
                                                                                                             subtitle:@"Subtitle"
                    ...
                    [elements release];
                } else if (itemIndex % 6 == 2) {
                    NSMutableArray<__kindof CPListImageRowItemElement *> *elements = [NSMutableArray new];
                    
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemCondensedElement *element = [[CPListImageRowItemCondensedElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]
                                                                                                                     imageShape:CPListImageRowItemCondensedElementShapeCircular
                                                                                                                          title:@"Condensed (Circular)"
                                                                                                                       subtitle:@"Subtitle"
                                                                                                            accessorySymbolName:@"checkmark"];
                        [elements addObject:element];
                        [element release];
                    }
                    ...
                    item = [[CPListImageRowItem alloc] initWithText:@(itemIndex).stringValue
                                                ...
                                                allowsMultipleLines:YES];
                    [elements release];
                } else if (itemIndex % 6 == 3) {
                    NSMutableArray<__kindof CPListImageRowItemElement *> *elements = [NSMutableArray new];
                    
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemCondensedElement *element = [[CPListImageRowItemCondensedElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]
                                                                                                                     imageShape:CPListImageRowItemCondensedElementShapeRoundedRectangle
                                                                                                                          title:@"Condensed (Rectangle)"
                                                                                                                       subtitle:@"Subtitle"
                                                                                                            accessorySymbolName:@"checkmark"];
                        [elements addObject:element];
                        [element release];
                    ...
                    item = [[CPListImageRowItem alloc] initWithText:@(itemIndex).stringValue
                                                ...
                                                allowsMultipleLines:YES];
                    [elements release];
                } else if (itemIndex % 6 == 4) {
                    NSMutableArray<__kindof CPListImageRowItemElement *> *elements = [NSMutableArray new];
                    
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemGridElement *element = [[CPListImageRowItemGridElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]];
                        [elements addObject:element];
                        [element release];
                    }
                    ...
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemImageGridElement *element = [[CPListImageRowItemImageGridElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]
                                                                                                                     imageShape:CPListImageRowItemImageGridElementShapeCircular
                                                                                                                          title:@"ImageGrid"
                                                                                                            accessorySymbolName:@"checkmark"];
                        [elements addObject:element];
                        [element release];
                    ...
                    for (NSUInteger i = 0; i < 3; i++) {
                        CPListImageRowItemImageGridElement *element = [[CPListImageRowItemImageGridElement alloc] initWithImage:[UIImage systemImageNamed:@"apple.intelligence"]
                                                                                                                     imageShape:CPListImageRowItemImageGridElementShapeRoundedRectangle
                                                                                                                          title:@"ImageGrid"
                                                                                                            accessorySymbolName:@"checkmark"];
                        [elements addObject:element];
                        [element release];
    ...
    if (@available(iOS 26.0, *)) {
        NSMutableArray<CPGridButton *> *headerGridButtons = [[NSMutableArray alloc] initWithCapacity:CPListTemplate.maximumHeaderGridButtonCount];
        
        for (NSUInteger i = 0; i < CPListTemplate.maximumHeaderGridButtonCount; i++) {
            CPMessageGridItemConfiguration *configuration = [[CPMessageGridItemConfiguration alloc] initWithConversationIdentifier:@(i).stringValue unread:i % 2];
            
            CPGridButton *gridButton = [[CPGridButton alloc] initWithTitleVariants:@[@(i).stringValue] image:[UIImage systemImageNamed:@"apple.intelligence"] messageConfiguration:configuration handler:^(CPGridButton * _Nonnull barButton) {
                [barButton updateImage:[UIImage systemImageNamed:@"checkmark"]];
                [barButton updateTitleVariants:@[@"Triggered!"]];
            }];
            [configuration release];
            
            [headerGridButtons addObject:gridButton];
            [gridButton release];
        }
        
        listTemplate.headerGridButtons = headerGridButtons;
        [headerGridButtons release];
    }
